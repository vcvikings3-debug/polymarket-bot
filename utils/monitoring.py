...
from config import SENTRY_DSN, DISCORD_WEBHOOK_URL

DISCORD_COLOR_GREEN = 3066993    # BET_YES
DISCORD_COLOR_RED = 15158332     # BET_NO
...
def send_discord_alert(title, message, color=None):
    ...
    if not DISCORD_WEBHOOK_URL:
        logger.warning("DISCORD_WEBHOOK_URL not configured — Discord alert skipped: {}", title)
        return
    if color is None:
